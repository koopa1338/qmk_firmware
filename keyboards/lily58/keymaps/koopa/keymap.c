...
[_L_1] = LAYOUT(
 ...
 // |--------+--------+--------+--------+--------+--------|                        |--------+--------+--------+--------+--------+--------|
     CW_TOGG ,KC_EXLM ,  KC_AT ,KC_HASH , KC_DLR ,KC_PERC ,                         KC_CIRC ,KC_AMPR ,KC_ASTR ,KC_TILD ,  GRAD  ,   INC  ,
 // |--------+--------+--------+--------+--------+--------|                        |--------+--------+--------+--------+--------+--------|
 ...
 // `-----------------------------------------------------|---------|    |---------|-----------------------------------------------------'
                              KC_TRNS,  KC_NO , KC_TRNS ,     KC_NO ,      QK_LEAD ,      KC_NO ,  KC_NO , KC_TRNS
 //                         |        |        |        |/          /      \          \ |        |        |        |
 //                         `-------------------------------------'        '----------''--------------------------'
),
/* Layer 2
...
void leader_end_user(void) {
    if (leader_sequence_two_keys(KC_Y, KC_Y)) {
        ...
        // delay for prefenting mistypes in terminals
        SEND_STRING_DELAY("sinner1991@gmail.com", 20);
    }
}
#endif // LEADER_ENABLE
